      ...
      videocontainer.addEventListener("click", function(){
         if(flag == 0){
          ...
          flag=1
            ...
            document.querySelector("#video-cursor").innerHTML=` <i class="ri-play-large-fill" style="font-size: 2vw"></i>`
          gsap.to("#video-cursor",{ 
            scale:1
          })
          flag=0
